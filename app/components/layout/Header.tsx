...
export function Header() {
  ...
  const { loading } = useUserConfig()
  const { nome, preferenciasVisuais } = usePerfilStore()
  ...
  return (
    <>
      ...
      <header className={`bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm ${
        preferenciasVisuais.reducaoEstimulos ? 'reduce-motion' : ''
      }`}>
            ...
            <Link href="/perfil">
              ...
              >
                <span className={`text-sm font-medium ${
                  preferenciasVisuais.textoGrande ? 'text-lg' : 'text-sm'
                }`}>
